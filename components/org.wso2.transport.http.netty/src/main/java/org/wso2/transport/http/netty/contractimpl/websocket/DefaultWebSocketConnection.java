...
public class DefaultWebSocketConnection implements WebSocketConnection {
    ...
    private WebSocketsMessageQueueHandler webSocketsMessageQueueHandler;
    ...
    public DefaultWebSocketConnection(ChannelHandlerContext ctx, WebSocketInboundFrameHandler frameHandler,
                                      WebSocketsMessageQueueHandler webSocketsMessageQueueHandler, boolean secure,
    ...
    public void readNextFrame() {
        webSocketsMessageQueueHandler.readNextFrame();
    }
