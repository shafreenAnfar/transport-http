...
import org.wso2.transport.http.netty.contractimpl.listener.WebSocketsMessageQueueHandler;
...
public class WebSocketInboundFrameHandler extends ChannelInboundHandlerAdapter {
    ...
    private final WebSocketsMessageQueueHandler webSocketsMessageQueueHandler;
    ...
    public WebSocketInboundFrameHandler(boolean isServer, boolean secureConnection, String target,
                                        ...
                                        WebSocketsMessageQueueHandler webSocketsMessageQueueHandler) {
        this.isServer = isServer;
        this.secureConnection = secureConnection;
        this.target = target;
        this.negotiatedSubProtocol = negotiatedSubProtocol;
        this.connectorFuture = connectorFuture;
        this.webSocketsMessageQueueHandler = webSocketsMessageQueueHandler;
    ...
    public void handlerAdded(ChannelHandlerContext ctx) {
        webSocketConnection = new DefaultWebSocketConnection(ctx, this, webSocketsMessageQueueHandler, secureConnection,
